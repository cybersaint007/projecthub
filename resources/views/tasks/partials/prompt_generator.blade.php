{{-- AI Prompt Generator: legacy tabbed view — generates ready-to-paste prompts from task data. --}}
<div class="bg-white shadow-sm sm:rounded-lg overflow-hidden"
     x-data="{ open: false, tab: 'claude' }">

    <button type="button" @click="open = !open"
            class="w-full flex items-center justify-between px-5 py-3 text-left hover:bg-gray-50 transition-colors">
        <span class="text-sm font-medium text-gray-700">{{ __('ui.ai_prompt_generator') }}</span>
    ...
    <div x-show="open" x-cloak class="border-t p-5">
