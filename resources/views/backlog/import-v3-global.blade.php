<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Import V3</h2>
                <p class="text-sm text-gray-500 mt-1">Creates or updates a project from canonical schema v3 JSON. Safe to re-run — existing records are matched by <code class="bg-gray-100 px-1 rounded">external_key</code> and updated, not duplicated.</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white shadow-sm sm:rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('backlog.import-v3.global.apply') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="json_payload" rows="18"
                        ...
                        placeholder='{
  "schema_version": "3.0",
  "project": { "external_key": "my-project", "name": "My Project" },
  "epics": []
